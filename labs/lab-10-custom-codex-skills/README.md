...
**Day 1 · Topic 3 · about 25 minutes · slides 96–101**  
**Surface:** Codex  
...
2. **Do the job by hand** — From BAK-111-mooncake.md, add a row to your project's data/courses.csv (from Lab 2), a brochure and a golden question. Run npm run check.
