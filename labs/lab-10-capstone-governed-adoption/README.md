...
**Course:** Agentic AI Applications with Codex (C695)
**Version:** v1.0
**Individual folder:** `labs/lab-10-capstone-governed-adoption/`
...
`Frame problem → Configure harness → Implement change → Verify outcome → Compare baseline → Recommend posture`

## Expected output

Working change, evidence pack and governed recommendation
...
1. Open `lab-10-capstone-governed-adoption/` and read this guide and `evidence/checklist.md` before starting.
...
5. Give Codex the bounded task in `prompt.md`: Use the full Codex workflow to improve TaskBoard. Preserve user changes, verify every acceptance criterion, compare with baseline, and issue a conditional adoption recommendation.
...
10. Compare the result with the acceptance rule: The solution works, the evidence pack covers correctness, efficiency and risk, and the recommendation states limits, controls, owner and review date.
...
The solution works, the evidence pack covers correctness, efficiency and risk, and the recommendation states limits, controls, owner and review date.
